...
//        val filepath = Spark.getFsBase() + "\\chap_07\\politic_bluehouse_5.txt"
    ...
    @Test def test02() {
        ...
        Assert.assertEquals(WordCount2Test.words.count(), 375)
    ...
    @Test def test03() {
        ...
        Assert.assertEquals(WordCount2Test.counts.first.getString(0), "기")
    ...
    @Test def test04() {
        ...
        Assert.assertEquals(WordCount2Test.sorted.first.getString(0), "장관")
